      ...
      >
        ...
        <SwiperSlide>
          <div className="single-slider slider-bg d-flex align-items-center p-relative">
            ...
            <div className="image-layer" style={{ backgroundImage: 'url(/img/gall/23807.webp)' }}></div>
              ...
              <div className="row justify-content-center align-items-center">
                <div className="col-lg-8 col-md-8">
                  <div className="slider-content s-slider-content">
                    ...
                    تقع في قلب الأعمال الشهير، ويحيط بهذا العنوان المميز معالم مشهورة مثل متحف المستقبل، ومركز دبي المالي العالمي (DIFC)
</p>
      ...
      <ContactFormAr />
        ...
        <SwiperSlide>
          <div className="single-slider slider-bg d-flex align-items-center p-relative">
            ...
            <div className="image-layer" style={{ backgroundImage: 'url(/img/gall/23808.webp)' }}></div>
            <div className="dark-overlay"></div>
            <div className="container">
              <div className="row justify-content-center align-items-center">
                <div className="col-lg-8 col-md-8">
                  <div className="slider-content s-slider-content">
                    ...
                    <p style={{paddingRight:"0"}}>
                    تتميز هذه الأبراج بموقعها المدروس لتمنح إطلالات خلابة على أفق مدينة دبي، من برج خليفة إلى الساحل، وهي مصممة لتقديم مشاهد بانورامية دون عوائق</p>
