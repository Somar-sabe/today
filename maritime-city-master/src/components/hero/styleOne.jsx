...
const HeroSectionStyleOne = () => {
    ...
    <section id="home" className="slider-area slider-four fix p-relative">
      <div className="call-box">
        <ul>
          <li>
            <div className="icon">
              <Image  src="/img/icons/phone-call.png" alt="Phone Call" width={40} height={40} />
            </div>
          </li>
          <li>
            <div className="text">
  ...
  height={200}
  placeholder="blur"
  blurDataURL="/placeholder-blur.png" // smaller blurry version
/>
        ...
        <SwiperSlide>
          <div className="single-slider slider-bg d-flex align-items-center p-relative">
            ...
            <div
              ...
              style={{ backgroundImage: 'url(/img/slider/16.jpg)' }}
            ></div>
              ...
              <div className="row justify-content-center align-items-center">
                <div className="col-lg-8 col-md-8">
                  <div className="slider-content s-slider-content">
                    <h2>
                      <span>Luxury &amp; Premium</span> Residences Flats
                    </h2>
                    <p>
                    offers a seamless blend of waterfront serenity and modern luxury, with breathtaking Bay and ocean views.
                    </p>
    ...
    Get A Consultation
        ...
        <SwiperSlide>
          <div className="single-slider slider-bg d-flex align-items-center p-relative">
            ...
            <div
              className="image-layer"
              style={{ backgroundImage: 'url(/img/bg/martime.avif)' }}
            ></div>
              <div className="dark-overlay"></div>
            <div className="container">
              <div className="row justify-content-center align-items-center">
                <div className="col-lg-8 col-md-8">
                  <div className="slider-content s-slider-content">
                    ...
                    <p>
                    Designed with Art Deco elegance and fluid architecture, it provides effortless indoor-outdoor living. Experience refined residences, world-class amenities, 
                    and a vibrant coastal lifestyle just minutes from Dubai’s dynamic heart.
                    </p>
