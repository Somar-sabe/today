...
<h3>Thank You!</h3>
<p>Your message has been successfully sent. Please check the downloads section to receive the brochure.</p>
...
<div className="formGroup" >
  ...
  <input type="email" id="email" name="email" placeholder="Your email" required />
          ...
          <div className="formGroup" >
          <label htmlFor="communication">What is the best way to contact you?</label>
