...
import HeroSectionStyleOnear from "@/components/hero/styleOnear";
import HeroSectionStyleFivear from "@/components/hero/styleFivear";
import Interestar from "@/components/intrest/intrestar";
import AboutUsStyleOneAr from "@/components/aboutUs/aboutUsStyleOneAr";
import ContactFormAr from "@/components/contactFormAr/contactFormAr";
import CounterUpar from "@/components/counterUpar";
import featuresData from "@/data/service";
import Gallery from "@/components/gallery/galleryar";
import ScrollToContact from "@/components/scroll-to-top-ar";
import PropertyDetailsInfo from "@/components/detail/detailar";
...
<AboutUsStyleOneAr sectionSpace="pt-120 pb-90" />
        <serviceItemThree/>
