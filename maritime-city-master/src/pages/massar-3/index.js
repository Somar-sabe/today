...
import MasaarSection from "@/components/massar/second";
import EverythingAtYourDoorstep from "@/components/massar/four";
import AmenitiesSection from "@/components/massar/five";
import FullScreenImage from "@/components/massar/seven";
import FullScreenImages from "@/components/massar/six";
import FullScreenImagess from "@/components/massar/eight";
import FullScreenImagessss from "@/components/massar/ten";
...
<MasaarHero openPopup={() => setOpenPopup(true)}   />
  
<MasaarSection openPopup={() => setOpenPopup(true)}  />
<FullScreenImage  />
<EverythingAtYourDoorstep openPopup={() => setOpenPopup(true)} />
<FullScreenImages  />
<AmenitiesSection openPopup={() => setOpenPopup(true)} />
<FullScreenImagess  />
<PaymentPlanSection openPopup={() => setOpenPopup(true)} />
<FullScreenImagessss  />
